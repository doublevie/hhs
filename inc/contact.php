<section class="fdb-block pb-0 bg-dark" id="contact" style="background-color:#6A1B9A!important">
    ...
    <div class="container-fluid p-0">
      <iframe class="map" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDeWf9gIbJZ4BV31Ns3EYxbvQm9N0rpTKM&q=hotel+el+hidhab+setif" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen=""></iframe>
    </div>
  </section>
